//
//  AirTicketCalendarViewController.swift
//  Peko
//
...
class AirTicketCalendarViewController: MainViewController {
 ...
 //   public var delegate: AirTicketCalendarViewControllerDelegate!
...
//    }
//    
    public var selectedColor = UIColor.redButtonColor //UIColor(red: 66/255.0,
    
    var completionBlock:((_ startDate: Date) -> Void)?
    
    static func storyboardInstance() -> AirTicketCalendarViewController? {
        return AppStoryboards.Air_Ticket.instantiateViewController(identifier: "AirTicketCalendarViewController") as? AirTicketCalendarViewController
    }
    ...
    override func viewDidLoad() {
       ...
       // self.setTitle(title: "Select Departure Date")
    ...
    @IBAction func doneButtonClick(_ sender: Any) {
        ...
        if completionBlock != nil {
            self.completionBlock!(self.selectedStartDate!)
        }
...
extension AirTicketCalendarViewController:UICollectionViewDataSource, UICollectionViewDelegate {
...
extension AirTicketCalendarViewController : UICollectionViewDelegateFlowLayout {
...
extension AirTicketCalendarViewController {
